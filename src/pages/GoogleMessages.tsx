...
import { PhoneMessages } from "../generated/Google";
...
const instruction = (
  <React.Fragment>
    ...
    <p>
      if you set <code>showstatus</code> to <code>true</code>, the status
      indicators (e.g. delivered/read) will be shown.
    </p>
  </React.Fragment>
);
...
const GoogleMessages: React.FC = () => {
  const { setPhoneData } = useConfigStore();
  useEffect(() => {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = import.meta.env.BASE_URL + "styles/GoogleMessages.css";
    ...
    <PreviewLayout
      controls={
        <Controls
          ...
          titleText="google message threads"
          example={example}
